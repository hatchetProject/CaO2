...
IMAGENET_PATH=/data/wujunyi/dataset/imagenet/images
IMAGENET_TRAIN_PATH=/data/wujunyi/dataset/imagenet/images/train
IMAGENET_VAL_PATH=/data/wujunyi/dataset/imagenet/images/val
...
python main_validate.py --subset "imagenet-1k" --arch-name "resnet18" --factor 2 \
    ...
    --syn-data-path results/1k_rn18_ipc10=46.1


python main_validate.py --subset "imagenet-1k" --arch-name "resnet18" --factor 2 \
    --num-crop 1 --mipc 300 --ipc 10 --stud-name "resnet101" --re-epochs 300 \
    --train-dir $IMAGENET_TRAIN_PATH --val-dir $IMAGENET_VAL_PATH --repeat 3 \
    --syn-data-path results/1k_rn18_ipc10=46.1